  ...
  <?php if (have_posts()) : ?>
    ...
    <div class="singlepage" id="post-<?php the_ID(); ?>">
      ...
      <div class="cover">
        <div class="entry">
          <?php the_excerpt(); ?>
          <a class="readmore" href="<?php the_permalink(); ?>" title="<?php _e('Read more about', 'fungames'); the_title_attribute(); ?>"><?php _e('Read more', 'fungames'); ?>&raquo;</a>
					<div class="clear"></div>
        </div>
      </div>
    </div>
    ...
    <div id="navigation">
      ...
      <?php else: ?>
        <div class="post-nav clearfix">
          <p id="previous"><?php next_posts_link(__('Older contests &laquo;', 'fungames')) ?></p>
          <p id="next-post"><?php previous_posts_link(__('&raquo; Newer contests', 'fungames')) ?></p>
        </div>
      <?php endif; ?>
    </div>
    ...
    <div class="singlepage">
      <h2 class="title"><?php _e('Not Found' , 'fungames'); ?></h2>
      <div class="cover">
        <div class="entry">
