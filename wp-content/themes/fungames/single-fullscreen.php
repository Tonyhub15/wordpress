...
<?php if ( get_option('fungames_custom_headercode_status') == 'enable' ) { echo stripslashes( get_option('fungames_custom_headercode') ); } ?>
...
// custom footer code
if ( get_option('fungames_custom_footercode_status') == 'enable' ) { echo stripslashes(get_option('fungames_custom_footercode')); }
?>
</body>
</html>